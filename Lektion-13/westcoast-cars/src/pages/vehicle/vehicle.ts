...
const loadVehicle = async (id: number): Promise<IVehicle | null> => {
  return await new HttpClient('vehicles').findVehicle(+id) as IVehicle;
};

const createPageHeader = (vehicle: IVehicle | string) => {
